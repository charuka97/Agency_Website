...
import ProductImg from "../assets/productLgo.png";
            ...
            <div>
              ...
              <div>
                <div className="flex item-center gap-8 flex-wrap">
                  <img
                    src="/src/assets/companyLogo/Logo1.png"
                    alt=""
                    className="cursor-pointer"
                  />
                  <img
                    src="/src/assets/companyLogo/Logo2.png"
                    alt=""
                    className="cursor-pointer"
                  />
                  <img
                    src="/src/assets/companyLogo/Logo3.png"
                    alt=""
                    className="cursor-pointer"
                  />
                  <img
                    src="/src/assets/companyLogo/Logo4.png"
                    alt=""
                    className="cursor-pointer"
                  />
                  <img
                    src="/src/assets/companyLogo/Logo5.png"
                    alt=""
                    className="cursor-pointer"
                  />
                  <img
                    src="/src/assets/companyLogo/Logo6.png"
                    alt=""
                    className="cursor-pointer"
                  />
